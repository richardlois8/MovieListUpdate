...
import com.rich.movielistapi.databinding.FragmentFavoriteListBinding
...
class FavoriteListFragment : Fragment() {
    ...
    private lateinit var favAdapter : com.rich.movielistapi.adapter.FavoriteMovieAdapter
    ...
    private fun showFavoriteMovies(data : List<FavoriteMovie>) {
        favAdapter =
            com.rich.movielistapi.adapter.FavoriteMovieAdapter(data)
