...
class MovieListFragment : Fragment() {
    ...
    private fun showBottomNav() {
        val packageId = requireActivity().packageName
        if(packageId == "com.rich.movielistapi.free") {
            (activity as MainActivity).binding.bottomNavigaton.visibility = View.GONE
        }else{
            (activity as MainActivity).binding.bottomNavigaton.visibility = View.VISIBLE
        }
    }
